...
<script>
    $(function () {
        $("#createOrderForm").submit(function () {
            return checkPost()&&checkMobile(mobile)&&checkEmpty($("#province"))&&checkEmpty($("#city"))
            &&checkEmpty($("#address"))&&checkEmpty($("#receiver"));
        });
        ...
        function checkPost() {
            ...
            if (!flag){
                ...
                $("#post").css("border","1px solid green")
            }
            return flag;
        }
...
<div class="buyPageDiv">
    <form id="createOrderForm" action="forecreateOrder" method="post">
        ...
        <div class="address">
            ...
            <div>
                <table class="addressTable">
                    <<input type="hidden" id="useAgoAddress" name="useAgoAddress" value="false">
                    <tr>
                        <td class="firstColumn">地址<span class="redStar">*</span></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><textarea  id="address" name="address" placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码，楼层和房间号等信息"></textarea></td>
                    </tr>
                    <tr>
                        <td>邮政编码</td>
