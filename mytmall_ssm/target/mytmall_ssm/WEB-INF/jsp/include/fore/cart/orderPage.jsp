            ...
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td class="orderItemDeleteTD">
                        <c:if test="${o.status!='waitDelivery' && o.status!='waitConfirm'}">
                    ...
                    <tr class="orderItemProductInfoPartTR" >
                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}" width="120px" class="orderListItemProductRealPriceTD orderItemOrderInfoPartTD">
                                <div class="orderListItemProductRealPrice">￥<fmt:formatNumber  minFractionDigits="2"  maxFractionDigits="2" type="number" value="${o.money}"/></div>
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
                                ...
                                <c:if test="${o.status=='waitPay' }">
                                    <a href="forealipay?oid=${o.id}&total=${o.money}">
                                ...
                                <c:if test="${o.status=='waitDelivery' }">
                                    <span>待发货</span>
                                    <button class="btn btn-info btn-sm ask2delivery" link="admin_order_deliveryajax?id=${o.id}">催卖家发货</button>
                                </c:if>
