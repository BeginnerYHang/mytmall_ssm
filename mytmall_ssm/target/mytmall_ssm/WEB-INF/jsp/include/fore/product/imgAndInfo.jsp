...
<script>
    ...
    $(function(){
        ...
        <!--点击立即购买和加入购物车时会去进行登录验证,如果已登录则可以操作,未登录则弹出模态登录窗口-->
                        ...
                        $.get(
                            ...
                            function(result){
                                if("success"==result){
                                    ...
                                    var cartNum = Number($("#cartNum").html()) + Number(num);
        ...
        $("button.loginSubmitButton").click(function(){
            ...
            if(0==name.length||0==password.length||0===checkCode.length){
                $("span.errorMessage").html("账号密码或验证码不能为空");
            ...
            $.get(
                page,
                {"username":name,"password":password,"checkCode":checkCode},
                function(result){
                    if("success"==result){
                        //成功登录则刷新一下页面即可
                        location.reload();
